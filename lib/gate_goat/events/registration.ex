defmodule GateGoat.Events.Registration do
  ...
  def changeset(registration, attrs) do
    registration
    |> cast(attrs, [:sca_name, :legal_name, :membership_number, :membership_expiration_date, :group_name, :waiver, :feast_option, :camping_option])
    |> validate_required([:sca_name, :legal_name, :membership_number, :membership_expiration_date, :group_name, :waiver, :feast_option, :camping_option])
