...
#  def fixture(:fee) do
#    {:ok, fee} = Fees.create_fee(@create_attrs)
#    fee
#  end
#
#  describe "index" do
...
#      conn = get(conn, fee_path(conn, :new))
...
#      conn = post(conn, fee_path(conn, :create), fee: @create_attrs)
#
#      assert %{id: id} = redirected_params(conn)
#      assert redirected_to(conn) == Routes.fee_path(conn, :show, id)
#
#      conn = get(conn, fee_path(conn, :show, id))
...
#      conn = get(conn, fee_path(conn, :edit, fee))
...
#      conn = put(conn, fee_path(conn, :update, fee), fee: @update_attrs)
...
#        get(conn, fee_path(conn, :show, fee))
#      end
#    end
#  end
#
